# ResNet-50 full fine-tuning with augmentation, 8 epochs, with AMP
...
def main():
    ...
    # ==============================
    # ResNet-50 full fine-tuning with Augmentation and AMP
    # ==============================
    ...
    best_epoch = 0
    counter = 0
    best_model_path = "resnet50_aug_amp.pth"
    ...
    final_model_path = "resnet50_aug_amp.pth"
    torch.save(model_resnet_full.state_dict(), final_model_path)
    print(f"Augmentation experiment model saved as {final_model_path}")
